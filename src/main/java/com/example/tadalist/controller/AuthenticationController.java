...
import com.example.tadalist.model.dto.LoginFormDTO;
import com.example.tadalist.model.dto.RegisterFormDTO;
...
public class AuthenticationController {
    ...
    public String processRegistrationForm(@ModelAttribute @Valid RegisterFormDTO registerFormDTO,
        ...
        if (!password.equals(verifyPassword)) {
            errors.rejectValue("password", "passwords.mismatch", "Oops! Passwords do not match");
            model.addAttribute("title", "Register");
            return "register";
        }

        User newUser = new User(registerFormDTO.getFirstName(), registerFormDTO.getEmail(), registerFormDTO.getPassword());
